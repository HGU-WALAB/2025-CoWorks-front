      ...
      >
        ...
        <div className="flex items-center space-x-2 ml-2 text-xs text-gray-500">
          ...
          {folder.documentsCount > 0 && (
            <div className="flex items-center bg-blue-100 text-blue-600 px-1.5 py-0.5 rounded-full">
          ...
          {folder.childrenCount > 0 && (
            <div className="flex items-center bg-yellow-100 text-yellow-600 px-1.5 py-0.5 rounded-full">
              <svg className="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                <path d="M2 6a2 2 0 012-2h5l2 2h5a2 2 0 012 2v6a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" />
              </svg>
